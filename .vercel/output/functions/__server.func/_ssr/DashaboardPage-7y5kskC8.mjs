...
function MobileTabBar({ active, onSelect }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dash-mobile-tabs", children: TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "dash-profile-form", onSubmit: handleSave, noValidate: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-fields-grid", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "dash-field-label", htmlFor: "dp-name", children: "Full Name" }),
          ...
          errors.name && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-field-error", children: errors.name })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-field", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-field-label", children: "Member Since" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-field-value", children: user.joined_at ?? "—" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-field-label", children: "Account ID" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-field-value dash-field-mono", children: user.id ?? "—" })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-sub-plans-grid", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dash-plan-radio", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `dash-plan-radio-dot ${selectedPlan === "monthly" ? "dash-plan-radio-dot-active" : ""}` }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "dash-plan-label", children: "Monthly Plan" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "dash-plan-price-row", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-plan-currency", children: "Rs" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-plan-price", children: "500" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-plan-period", children: "/ month" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "dash-plan-note", children: "Excl. GST · Cancel anytime" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dash-plan-badge", children: "Best Value" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dash-plan-radio", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `dash-plan-radio-dot ${selectedPlan === "annual" ? "dash-plan-radio-dot-active" : ""}` }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "dash-plan-label", children: "Annual Plan" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "dash-plan-price-row", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-plan-currency", children: "Rs" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-plan-price", children: "4,500" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-plan-period", children: "/ year" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "dash-plan-note", children: "Excl. GST · Save 25%" })
              ] })
            ]
          }
        )
