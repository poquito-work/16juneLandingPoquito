...
const appCss = "/assets/styles-YMIlD7Em.css";
...
const Route$3 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Poquito landing page" },
      { name: "description", content: "Poquito Mahjong Club is a premium, minimalist landing page for a subscription-based Traditional Mahjong platform." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Poquito landing page" },
      { property: "og:description", content: "Poquito Mahjong Club is a premium, minimalist landing page for a subscription-based Traditional Mahjong platform." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Poquito landing page" },
      { name: "twitter:description", content: "Poquito Mahjong Club is a premium, minimalist landing page for a subscription-based Traditional Mahjong platform." },
...
const $$splitComponentImporter = () => import("./index-CgHfeyNC.mjs");
