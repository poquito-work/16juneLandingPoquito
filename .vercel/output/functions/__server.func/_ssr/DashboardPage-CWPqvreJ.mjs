...
import { h as getUserProfile, d as getPredefinedListByType, i as getTransactionList, j as getPackageList, u as updateUserProfile, k as initializeSubscription, m as upgradeSubscription, n as cancelSubscription } from "./Logo-P9rwXXYM.mjs";
import { H as Header, F as Footer } from "./Footer-Y1q3l62x.mjs";
...
function SubscriptionTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-section", children: [
    ...
    !trialEndedWithoutSubscription && subscription && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dash-sub-current", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-sub-current-left", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "dash-sub-plan-price", children: "Next billing on" }),
