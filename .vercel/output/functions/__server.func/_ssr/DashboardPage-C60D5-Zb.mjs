...
import { i as getUserProfile, d as getPredefinedListByType, j as getTransactionList, h as getPackageList, k as deleteAccount, u as updateUserProfile, m as initializeSubscription, n as upgradeSubscription, o as cancelSubscription } from "./Logo-BVGl1KFU.mjs";
import { H as Header, F as Footer } from "./Footer-brwiANrK.mjs";
...
import { d as Trash2, U as User, M as Mail, S as Smartphone, a as MapPin, C as ChevronsUpDown } from "../_libs/lucide-react.mjs";
...
function getUserFromToken() {
  ...
  return {
    ...
    other_city: payload?.other_city,
    city: payload?.city ?? "",
    avatar_url: payload?.picture ?? "",
    joined_at: payload?.iat ? new Date(payload.iat * 1e3).toLocaleDateString("en-IN", {
      year: "numeric",
      month: "long",
      day: "numeric"
    }) : "—"
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "svg",
      {
        ...
        strokeLinecap: "round",
        strokeLinejoin: "round",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z" })
      }
    )
  },
  {
...
function Sidebar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "dash-sidebar", children: [
...
function ProfileTab({
  ...
  reactExports.useEffect(() => {
    getPredefinedListByType("CITY", true).then((res) => setCityList(res.data.content ?? [])).catch(() => {
    });
  }, []);
  ...
  reactExports.useEffect(() => {
    ...
    setForm((prev) => ({
      ...
      phone_number: user.phone_number !== void 0 ? user.phone_number ?? "" : prev.phone_number,
      city: matchedCity?.name ?? prev.city,
      avatar_url: user.avatar_url ?? prev.avatar_url,
      other_city: user.other_city !== void 0 ? user.other_city ?? "" : prev.other_city
    }));
    console.log({
      city: form.city,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-section", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-profile-hero", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-avatar", children: [
        ...
        form.avatar_url ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "avatar-wrapper", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: form.avatar_url || user.avatar_url, alt: "Avatar", className: "uploadLogo" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "dash-profile-name", children: form.username || user.username || "—" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "dash-profile-form", onSubmit: handleSave, noValidate: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-fields-grid", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronsUpDown, { className: "ml-2 h-4 w-4 opacity-50" })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                PopoverContent,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Command, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollArea, { className: "h-64", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CommandGroup, { className: "max-h-64 overflow-y-auto custom-scrollbar", children: cityList.map((city) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        CommandItem,
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollBar, { className: "w-1", orientation: "vertical" })
                    ] })
                  ] })
                }
              )
        ...
        form.city.toLowerCase() === "other" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reg-field", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-section", children: [
    ...
    transactionList?.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-empty", children: [
      ...
      totalPages > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-pagination", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setPage((p) => p - 1), disabled: page === 0, children: "Previous" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setPage((p) => p + 1), disabled: page + 1 >= totalPages, children: "Next" })
      ] })
    ] }),
...
function SubscriptionTab({
      ...
      DialogContent,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: " flex flex-col gap-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: " space-y-3 text-[0.95rem] text-cream/85 leading-relaxed", children: plan === "monthly" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream/55 text-[0.95rem]", children: "To cancel, go to 'My Account' and select 'Subscription'" })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-section", children: [
    ...
    !trialEndedWithoutSubscription && subscription && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dash-sub-current", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-sub-current-left", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-sub-change", children: [
      ...
      subscription && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-8", children: [
        "If you want to switch to the",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: subscription?.plan.billing_cycle === "monthly" ? "Annual" : "Monthly" }),
        " ",
        "Plan, your current",
        " ",
        ...
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: formatDate(subscription?.current_period_end ?? null) }),
        ". Starting",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: addOneDay(subscription?.current_period_end ?? null) }),
        ", your subscription will automatically switch to the",
        " ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dash-sub-plans-grid", children: plans.filter((plan) => {
          if (!subscription) {
            return true;
          }
    ...
    ${subscription?.plan.id === plan.id ? "reg-plan-card-selected" : ""}`,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "reg-plan-price-row", children: [
                    ...
                    plan.billing_cycle === "monthly" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                  ...
                  // </p>
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-cream/75", children: plan?.price_per_unit_equiv ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-xs text-cream/75", children: [
                  ...
                  plan.billing_cycle === "annual" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-cream/75", children: plan.gst_excluded ? "Excl GST" : "" }),
                  plan.billing_cycle === "monthly" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-foreground/65", children: plan.gst_excluded ? "Excl GST" : "" }),
                ...
                plan.billing_cycle === "monthly" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                ...
                ) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
        ...
        subscription && (subscription.status === "active" || subscription.status === "trialing") && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "dash-info-note", children: [
...
function DashboardPage({ activeTab: initialTab }) {
  ...
  function fetchUserProfile() {
    return getUserProfile().then((res) => {
      ...
      setUser((prev) => ({
        ...
        other_city: data.other_city !== void 0 ? data.other_city : prev.other_city,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-body", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { active: activeTab, onSelect: handleTabSelect, onDeleteClick: () => setShowDeleteDialog(true) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "dash-main", children: [
        activeTab === "profile" && /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileTab, { user, onProfileUpdated: fetchUserProfile }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showDeleteDialog, onOpenChange: setShowDeleteDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: " rounded-[32px] border-0 p-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#F8F1E7] px-8 py-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mb-6  rounded-full bg-[#D9CCB9]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto flex h-12 w-12 items-center justify-center radius-full rounded-full border border-[#b65a2f]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-6 w-6 text-[#b65a2f]" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-6 text-2xl font-bold tracking-wide text-[#2E2A24]", children: "DELETE ACCOUNT" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-[15px] leading-7 text-[#6A625A]", children: "Deleting your account is permanent and cannot be undone. Your profile, game history, statistics, friends, achievements, and all associated data will be permanently deleted." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-lg font-medium text-[#2E2A24]", children: "Are you sure?" }),
