...
const $$splitComponentImporter$8 = () => import("./terms-tERwfyDW.mjs");
...
const $$splitComponentImporter$6 = () => import("./privacy-WGqKr-Nf.mjs");
...
const MyaccountTransactionRoute = Route$2.update({
  id: "/transaction",
  path: "/transaction",
  getParentRoute: () => MyaccountRoute
});
const MyaccountSubscriptionRoute = Route$1.update({
  id: "/subscription",
  path: "/subscription",
  getParentRoute: () => MyaccountRoute
});
const MyaccountProfileRoute = Route.update({
  id: "/profile",
  path: "/profile",
  getParentRoute: () => MyaccountRoute
});
const MyaccountRouteChildren = {
  ...
  MyaccountSubscriptionRoute,
  MyaccountTransactionRoute
};
