...
import { g as getTermsCondition, a as getPrivacyPolicy, P as PocketDragonLogo, c as checkEmailExists, b as checkUserExists, s as sendOtp, d as getPredefinedListByType, r as registerUser } from "./Logo-BwyYshP5.mjs";
...
function StepDetails({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "reg-form", onSubmit: handleSubmit, noValidate: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "avatar-wrapper", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: data.avatar_url || avtarBoy, alt: "Avatar", className: "uploadLogo" }),
