...
import { H as Header, F as Footer, l as logoSrc, t as tile1, a as tile2, b as tile3 } from "./Footer-BaP0kRBb.mjs";
import { D as Dialog, a as DialogContent, b as DialogHeader, d as DialogTitle, e as DialogDescription } from "./dialog-DyVH2Cto.mjs";
import { h as getPackageList, l as loginUser } from "./Logo-CBqgdkSE.mjs";
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.p,
                    {
                      ...
                      children: "Practice, play, and compete your way to the top! Enjoy real-time and offline Mahjong action at your fingertips"
                    }
                  ),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "flex items-center gap-2 pt-1 heroText", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex -space-x-2 socialRound", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: avtarBoy, className: "height-30" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: avtarGirl }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: avtarBunny })
                    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-5 py-14 sm:px-8 md:py-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "articleClass mx-auto mt-12 grid max-w-3xl gap-5 sm:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "plan-monthly-card relative flex flex-col rounded-2xl border border-foreground/15  p-7", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[0.7rem] font-bold uppercase tracking-[0.28em] text-foreground/70", children: monthlyPlan?.name || "Monthly Plan" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex items-baseline gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-5xl font-bold leading-none", style: { color: "var(--foreground)" }, children: [
              "  ",
              monthlyPlan?.price
            ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "orbit-stage", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "orbit-features orbit-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "orbit-feature-card ", id: "ofc-practice", "data-screen": "practice", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ofc-tags", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ofc-tag text-rustOffline", children: "Offline" })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "orbit-phone-wrap", id: "orbit-phone-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "orbit-phone-device", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "orbit-phone-inner", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "orbit-phone-screen", id: "orbit-screen", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-screen screen-practice ", id: "screen-practice", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-screen screen-match active", id: "screen-match", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-statusbar", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "app-time", children: "9:41" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "app-signal", children: "●●●" })
              ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "orbit-features orbit-right", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "orbit-feature-card", id: "ofc-league", "data-screen": "league", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ofc-connector ofc-connector-left" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ofc-text", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "26", height: "26", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round", className: "lucide lucide-crown text-rust transition-transform duration-300 group-hover:scale-110", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M11.562 3.266a.5.5 0 0 1 .876 0L15.39 8.87a1 1 0 0 0 1.516.294L21.183 5.5a.5.5 0 0 1 .798.519l-2.834 10.246a1 1 0 0 1-.956.734H5.81a1 1 0 0 1-.957-.734L2.02 6.02a.5.5 0 0 1 .798-.519l4.276 3.664a1 1 0 0 0 1.516-.294z" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ofc-text-content", children: [
            ...
            "div",
            {
              ...
              children: [
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(EyeIcon2, { visible: showPass })
                            }
                          )
                        ]
                      }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-pq-green/70 text-sm font-normal", children: [
                  ...
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/register", className: "f-w-600 text-rust font-normal hover:underline underline-offset-2", children: "Create an account" })
                ] })
              ]
            }
          )
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 scale-[3]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoSrc, alt: "Pocket Dragon", style: { height: "56px", width: "auto", opacity: 0.9 } }) })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
