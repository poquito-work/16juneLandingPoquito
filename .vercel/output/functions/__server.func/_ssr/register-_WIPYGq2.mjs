...
import { g as getTermsCondition, a as getPrivacyPolicy, P as PocketDragonLogo, c as checkEmailExists, b as checkUserExists, s as sendOtp, d as getPredefinedListByType, r as registerUser } from "./Logo-rNH89EBJ.mjs";
...
function StepDetails({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "reg-form", onSubmit: handleSubmit, noValidate: true, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "avatar-text mb-5", children: "Tap to choose your avatar" }),
