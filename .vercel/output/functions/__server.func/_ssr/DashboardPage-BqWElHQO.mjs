...
import { h as getUserProfile, d as getPredefinedListByType, i as getTransactionList, j as getPackageList, u as updateUserProfile, k as initializeSubscription, m as upgradeSubscription, n as cancelSubscription } from "./Logo-BV4hGwA1.mjs";
import { H as Header, F as Footer } from "./Footer-CLACDUKU.mjs";
...
function ProfileTab({ user }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-section", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-profile-hero", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dash-avatar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dash-avatar-initials", children: initials }) }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "avatar-modal-header", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Select Avatar" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "avatar-grid", children: avatarList.map((avatar) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    src: avatar.url,
                    className: `avatar-item ${user.avatar_url === avatar.url ? "selected" : ""}`,
                    onClick: () => {
                      setForm((prev) => ({
                        ...prev,
...
function SubscriptionTab({
  ...
  async function handleCancelPlan() {
    ...
    const confirmResult = await Swal.fire({
      ...
      html: `If your next renewal is 3 or more days away, your subscription will end on your current renewal date.<br><br>If your next renewal is less than 3 days away, your upcoming payment will still be processed, and your subscription will end after the following billing cycle.`,
      // html: withinRenewalWindow
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-section", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-sub-change", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dash-sub-plans-grid", children: plans.map((plan) => {
        const isSelected = selectedPlanId !== null ? selectedPlanId === plan.id : subscription?.plan.id === plan.id;
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              isBestValue && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reg-plan-badge", children: "Best Value" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reg-plan-radio", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `reg-plan-radio-dot ${isSelected ? "reg-plan-radio-dot-active" : ""}` }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reg-plan-label", children: plan.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "reg-plan-price-row", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "reg-plan-price", children: plan.price.toLocaleString("en-IN") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "reg-plan-period", children: [
                    "/ ",
                    plan.billing_cycle === "monthly" ? "month" : plan.billing_cycle === "annual" ? "year" : plan.billing_cycle
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "reg-plan-note", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-sub-actions", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: showSubscribeButton ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", disabled: changing || !subscription || isDifferentPlanSelected, className: "dash-cancel-btn", onClick: handleCancelPlan, children: "Cancel Subscription" })
        ] }) }),
        !trialEndedWithoutSubscription && subscription && selectedPlanId === subscription.plan.id && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "dash-sub-same-note", children: "This is your current plan." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "dash-info-note", children: [
