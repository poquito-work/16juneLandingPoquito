...
const API_BASE_URL = "https://api.dev.poquito.review-link.in";
...
const getPredefinedListByType = async (entity_type, isSortedAlpha) => {
  const response = await axios.get(
    `${API_BASE_URL}/api/v1/admin/predefined/`,
    {
      params: {
        entity_type,
        ...isSortedAlpha !== void 0 && {
...
export {
  ...
  deleteAccount as k,
  loginUser as l,
  initializeSubscription as m,
  upgradeSubscription as n,
  cancelSubscription as o,
  registerUser as r,
  sendOtp as s,
