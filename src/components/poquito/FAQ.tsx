  ...
  return (
    ...
    >
      <button onClick={onToggle} className="w-full flex items-center justify-between gap-6 py-6 text-left group">
        <span
          className={`font-hero font-normal text-base leading-snug transition-all duration-300 group-hover:font-medium group-hover:scale-[1.00] ${
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <p className="text-pq-green text-sm font-light leading-relaxed pb-6 max-w-2xl hover:font-bold hover:scale-[1.00] transition-all duration-200">
              {faq.a}
            </p>
          </motion.div>
        )}
