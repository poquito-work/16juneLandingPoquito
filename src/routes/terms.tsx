      ...
      <div className="mx-auto max-w-3xl px-6 py-16 sm:px-10">
        ...
        <div className="flex flex-col gap-10 text-sm leading-relaxed text-foreground/80">
          ...
          <section>
            ...
            <p>For full details please see the Privacy Policy </p>
          </section>
          ...
          <section>
           ...
           <ul className="listUl flex flex-col gap-2">
            ...
            <p> Using the platform for any commercial purpose without written authorisation</p>
          </section>

            <section>
            <h2 className="text-base font-bold uppercase tracking-[0.12em] text-foreground mb-3">9.  Disclaimers & Limitation of Liability </h2>
            <p>TPocket Dragon is provided "as is." While we work hard to keep the platform running smoothly, we do not guarantee uninterrupted or error-free service.  </p>
           ...
           <ul className="listUl flex flex-col gap-2">
            ...
            <p>We encourage you to contact us first at <a href="admin@pocketdragon.in" title="admin@pocketdragon.in" className="text-rust hover:opacity-75 transition-opacity">admin@pocketdragon.in</a> before initiating any legal proceedings. Most issues can be resolved quickly and fairly.  </p>
          </section>
